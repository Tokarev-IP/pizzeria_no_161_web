    ...
    <div className="menu-container">
      <InfoBanner>
        ...
        <div className="info-banner-body">
          Пицца- это моё хобби и то чем я готов поделиться с другими любителями хрустящей пиццы из помпейской печи. Здесь Вы можете заказать аутентичную пиццу размером 40см которую я приготовлю при t 350°C при вас и для вас 😀. Для организации всего процесса Вам потребуется создать предварительный заказ и в случае если я смогу его исполнить, забрать заказ в согласованное время.
        </div>
      </InfoBanner>
