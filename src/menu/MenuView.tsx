  ...
  return (
    <div className="menu-container">
      <InfoBanner>
        ...
        Пицца — это моё хобби и то, чем я готов поделиться с другими любителями хрустящей пиццы из помпейской печи. Здесь вы можете выбрать аутентичную пиццу 40 см, которую я приготовлю при 350 °C всего за 3 минуты — прямо при вас. Для этого достаточно оставить предварительную заявку, и после её подтверждения вы сможете забрать пиццу в согласованное время. cin-cin.
        </div>
      </InfoBanner>
